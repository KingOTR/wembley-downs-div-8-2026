...
function syncAdminLocationFromStore() {
  ...
  import("./location-autocomplete.js?tag=v147")
    .then(function (mod) {
...
function wireLineupExportOverride() {
  ...
  btn.addEventListener(
    ...
    function (ev) {
      ev.stopImmediatePropagation();
      ev.preventDefault();
      import("./lineup-export.js?tag=v147")
        .then(function (mod) {
          var snap =
...
async function updateMatchCardWeather() {
  ...
  try {
    var mod = await import("./weather-forecast.js?tag=v147");
...
function wireLineupPublicTabs() {
  ...
  function setOverlay(mode) {
    ...
    import("./lineup-fotmob.js?tag=v147")
      .then(function (mod) {
